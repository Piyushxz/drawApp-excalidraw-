                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <div className="flex gap-2">
                                    <button onClick={()=>{
                                        ...
                                        props.game?.updateText(props.game?.clickedShapeIndex,24,props.game?.clickedShape?.fontFamily || "Satoshi")
                                    ...
                                    <button onClick={()=>{
                                        ...
                                        props.game?.updateText(props.game?.clickedShapeIndex,28,props.game?.clickedShape?.fontFamily || "Satoshi")
                                    ...
                                    <button onClick={()=>{
                                        ...
                                        props.game?.updateText(props.game?.clickedShapeIndex,32,props.game?.clickedShape?.fontFamily || "Satoshi")
                                    ...
                                    <button onClick={()=>{
                                        ...
                                        props.game?.updateText(props.game?.clickedShapeIndex,36,props.game?.clickedShape?.fontFamily || "Satoshi")
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <div className="flex gap-2">
                                    <button onClick={()=>{
                                        ...
                                        props.game?.updateText(props.game?.clickedShapeIndex,props.game?.clickedShape?.shape.fontSize || 24,props.game?.currentFont)
